...
- **Level 3** (blocked): Commit, write BLOCKED note in `claude-progress.txt`, continue with non-dependent tasks.
...
- Check `claude-progress.txt` for task status on restart

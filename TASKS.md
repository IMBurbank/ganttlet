...
- [x] **B1**: Fix CASCADE_DEPENDENTS collab sync (bug fix — do first) `feature/phase6-state-sync`
...
- [x] **B2**: Add new state fields and action types `feature/phase6-state-sync`
...
- [x] **B3**: Implement undo/redo in reducer `feature/phase6-state-sync`
...
- [x] **B4**: Update CASCADE_DEPENDENTS to track changed IDs `feature/phase6-state-sync`
  - File: `src/state/ganttReducer.ts`
...
- [x] **B5**: Wire up keyboard shortcuts for undo/redo `feature/phase6-state-sync`
  - File: `src/state/GanttContext.tsx`
  - Add `useEffect` for Ctrl+Z (undo) and Ctrl+Shift+Z (redo)

- [x] **B6**: Sync UNDO/REDO to collab `feature/phase6-state-sync`

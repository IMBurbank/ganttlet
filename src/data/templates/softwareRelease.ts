...
export const fakeChangeHistory: ChangeRecord[] = [
  ...
  },
  {
    ...
    user: 'Marcus Johnson',
    taskId: 'pe-3',
    taskName: 'Auth service refactor',
    field: 'endDate',
    oldValue: '2026-03-30',
    newValue: '2026-04-03',
  },
  {
    ...
    user: 'Priya Patel',
    taskId: 'ux-2',
    taskName: 'Wireframes & prototyping',
    field: 'owner',
    oldValue: '10',
    newValue: '30',
  },
  {
    ...
    user: 'Alex Rivera',
    taskId: 'pe-2',
    taskName: 'Database migration planning',
    field: 'owner',
    oldValue: 'Marcus Johnson',
  ...
  },
  {
    ...
    user: 'Jordan Kim',
    taskId: 'pe-6',
    taskName: 'Load testing & optimization',
    field: 'duration',
    oldValue: '8',
    newValue: '10',
  },
  {
    ...
    user: 'Marcus Johnson',
    taskId: 'pe-5',
    taskName: 'API endpoint implementation',
    field: 'startDate',
    oldValue: '2026-04-01',
    newValue: '2026-04-06',
  },
  ...
  },
  {
    ...
    user: 'Sarah Chen',
    taskId: 'root',
    taskName: 'Q2 Product Launch',
    field: 'name',
    oldValue: 'Q2 Release',
    newValue: 'Q2 Product Launch',
  },
  {
    id: 'ch-10',
    ...
    user: 'Alex Rivera',
    taskId: 'pe-7',
    taskName: 'CI/CD pipeline updates',
    field: 'notes',
    oldValue: 'Update CI',
    newValue: 'Update deploy scripts for new infra',
  },
  {
    id: 'ch-11',
